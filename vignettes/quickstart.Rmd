...
```{r tests}
# Include p-values (t-test for continuous, Fisher's exact for categorical)
table1(arm ~ age + sex, data = data, pvalue = TRUE)
...
# Mean +/- SE
table1(arm ~ age, data = data, numeric_summary = "mean_se")
