...
For more control, create a theme from scratch with custom CSS properties:

```{r custom-theme-advanced}
# Create a highly customized theme
corporate_theme <- create_custom_theme(
  ...
  css_properties = list(
    ...
    row_stripe_color = "#e8f4f8"
  )
)

cat("Corporate theme created with custom properties:\n")
str(corporate_theme[c("name", "decimal_places", "css_properties")])
```
