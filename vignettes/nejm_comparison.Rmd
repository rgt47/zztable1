...
The same data rendered with `theme = "lancet"` to show how the
theme changes the output. Binary variables are no longer
collapsed (Lancet shows all factor levels), missing data rows
appear, footnotes use numbers instead of symbols, and the
row striping is removed.
