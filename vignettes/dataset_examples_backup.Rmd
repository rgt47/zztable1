...
# Load package via devtools for vignette
devtools::load_all()
```
...
<div class="theme-title">3. Lancet Theme - Multi-center Trial Format</div>
<div class="theme-description">Stratified by cylinder count with comprehensive statistics</div>
...
<div class="theme-showcase">
<div class="theme-title">4. JAMA Theme (Journal of American Medical Association)</div>
<div class="theme-description">Professional medical journal styling with lettered footnotes</div>
...
<div class="theme-showcase">
<div class="theme-title">5. Simple Theme - Descriptive with Footnotes</div>
<div class="theme-description">Descriptive statistics with custom footnotes demonstration</div>

```{r theme-simple-demo}
# Create footnotes for the analysis
analysis_footnotes <- list(
  "a" = "Miles per gallon measured at highway speeds",
  "b" = "Horsepower measured at peak engine performance", 
  "c" = "Weight includes vehicle and standard equipment"
)
...
<div class="theme-showcase">
<div class="theme-title">NEJM Theme - Multi-group Analysis</div>

```{r iris-nejm}
# Demonstrate footnotes with NEJM theme (uses numbered footnotes)
nejm_footnotes <- list(
  "1" = "Data from Anderson's iris dataset (1935)",
  "2" = "Measurements standardized to nearest 0.1 cm", 
  "3" = "Statistical significance tested at α = 0.05"
)
...
<div class="theme-showcase">
<div class="theme-title">JAMA Theme - Multi-group Analysis</div>

```{r iris-jama}
# Demonstrate footnotes with JAMA theme (uses lettered footnotes)
iris_footnotes <- list(
  "a" = "Measurements taken from dried specimens",
  "b" = "All measurements in centimeters",
  "c" = "P-values from one-way ANOVA across species"
)
...
<div class="theme-showcase">
<div class="theme-title">Lancet Theme - Clinical Trial Format</div>
...
<div class="theme-showcase">
<div class="theme-title">Simple Theme - Report Format</div>
...
clinical_footnotes <- list(
  "a" = "VC = Vitamin C supplement (ascorbic acid)",
  "b" = "OJ = Orange juice as natural vitamin C source", 
  "c" = "Tooth length measured in microns",
  "d" = "Dose levels: 0.5, 1.0, and 2.0 mg/day"
)
