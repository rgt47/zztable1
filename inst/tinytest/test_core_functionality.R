...
expect_inherits(static_cell, c("cell", "cell_static"))
...
expect_inherits(comp_cell, c("cell", "cell_computation"))
...
expect_inherits(bp3, "table1_blueprint")
